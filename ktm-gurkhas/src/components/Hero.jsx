    ...
    <div className="relative bg-gradient-to-b from-black to-gray-900 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-6 max-w-lg mx-auto text-xl text-yellow-100">
            Courage. Honor. Victory. The pride of Nepal in the world of sports.
          </p>

          {/* Stats ribbon */}
          <div className="mt-12 max-w-md mx-auto bg-black bg-opacity-50 border border-yellow-100 border-opacity-30 rounded-lg p-4">
            <div className="flex justify-between text-yellow-100">
              <div className="text-center px-4">
                <div className="text-3xl font-bold text-gold-500">24</div>
                <div className="text-sm uppercase tracking-wider">Matches</div>
              </div>
